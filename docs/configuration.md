...
```json
{
  ...
  "Clockify": {
    "Interval": "00.00:05:00", // Specify the interval where the background worker should be started. default: 5 Minutes
    "Once": false, // if set to true, the application will exit after the first run. default: false
    "Workspaces": {
      "Default": {
        "ApiUrl": "https://api.clockify.me/api/v1",
        "ApiKey": "01234567890123456789012345678901234567890", // Your Clockify API key
    ...
    "Integrations": {
      ...
      "DevOpsPrivate": {
        ...
        "Args": {
          ...
          "Host": "https://dev.azure.com/PRIVATE-COLLECTION",
